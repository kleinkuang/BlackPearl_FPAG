...
set_property PACKAGE_PIN BB32                   [get_ports sys_error]
# - GPIO 2
set_property IOSTANDARD LVCMOS12                [get_ports sys_full]
set_property PACKAGE_PIN AY30                   [get_ports sys_full]
# - GPIO 1
set_property IOSTANDARD LVCMOS12                [get_ports fifo_full]
set_property PACKAGE_PIN AV34                   [get_ports fifo_full]
# - GPIO 0
...
set_false_path -from [get_clocks FT601Q_ft_clk] -to [get_clocks -of_objects [get_pins clk_inst/inst/mmcme4_adv_inst/CLKOUT0]]
