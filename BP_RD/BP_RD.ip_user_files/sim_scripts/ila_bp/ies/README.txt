...
#
# Generated by export_simulation on Mon Aug 24 17:23:45 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './ila_bp.sh' script.
...
./ila_bp.sh -noclean_files

For more information on the script, please type './ila_bp.sh -help'.
