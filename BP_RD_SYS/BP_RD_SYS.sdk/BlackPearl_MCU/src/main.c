...
void Exe_cmd()
{
    ...
    switch(func)
    {
        ...
        case 0x0204:	xil_printf("M: VDD2_EN\n");
                        temp_u = Get_GPIO_Bit(4);
        				xil_printf("   Val:      0x%X\n$%d#", temp_u, temp_u);
        				break;

        // - "set_delay"
        case 0x1205:    Set_Delay(par1);
        // - "get_delay"
        ...
        // - "set_freq_index"
        case 0x1206:    Set_Freq_Index(par1);
        // - "get_freq_index"
        case 0x0206:    xil_printf("M: Frequency Index\n");
                        temp_u = Get_Freq_Index();
                        xil_printf("   Val:      0x%X\n$%d#", temp_u, temp_u);
                        break;
