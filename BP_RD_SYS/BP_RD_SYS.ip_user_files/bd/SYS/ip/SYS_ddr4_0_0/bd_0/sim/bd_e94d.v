...
//--------------------------------------------------------------------------------
//Command: generate_target bd_e94d.bd
//Design : bd_e94d
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_e94d,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_e94d,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "SYS_ddr4_0_0_microblaze_mcs.hwdef" *) 
module bd_e94d
   (Clk,
    IO_addr_strobe,
    IO_address,
    ...
    TRACE_reg_write,
    TRACE_valid_instr);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_ASYNC_RESET Reset, CLK_DOMAIN bd_e94d_Clk, FREQ_HZ 100000000, INSERT_VIP 0, PHASE 0.000" *) input Clk;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 >  bd_e94d lmb_bram_I bd_e94d second_lmb_bram_I" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_e94d_dlmb_cntlr_0 dlmb_cntlr
  ...
  bd_e94d_ilmb_cntlr_0 ilmb_cntlr
  ...
  bd_e94d_iomodule_0_0 iomodule_0
       (.Clk(Clk2),
  ...
  bd_e94d_lmb_bram_I_0 lmb_bram_I
  ...
  (* BMM_INFO_PROCESSOR = "microblaze-le > bd_e94d dlmb_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  bd_e94d_microblaze_I_0 microblaze_I
       (.Byte_Enable(dlmb_BE),
        .Clk(Clk2),
        .DCE(dlmb_CE),
        .DReady(dlmb_READY),
  ...
  bd_e94d_second_dlmb_cntlr_0 second_dlmb_cntlr
  ...
  bd_e94d_second_ilmb_cntlr_0 second_ilmb_cntlr
  ...
  bd_e94d_second_lmb_bram_I_0 second_lmb_bram_I
